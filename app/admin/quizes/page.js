                            ...
                            {quizes.map((quiz, index) => (
                                <tr key={quiz.id} className="border-b transition hover:bg-gray-100">
                                    ...
                                    <td className="p-4 text-center flex justify-center gap-3">
                                        <Link href={`/admin/quizes/view/${quiz.id}`} className="px-4 py-2 bg-blue-400 text-white rounded-lg hover:bg-yellow-600 transition">
View
                                        </Link>
                                        <Link href={`/admin/quizes/edit/${quiz.id}`} className="px-4 py-2 mx-2 bg-yellow-400 text-white rounded-lg hover:bg-yellow-600 transition">
                                            Edit
                                        </Link>
